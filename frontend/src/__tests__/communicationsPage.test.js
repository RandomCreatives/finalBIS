...
describe('Admin Communications queue', () => {
    ...
    test('store tab links to the full Store page; conduct tab previews the next phase', async () => {
        renderPage();
        ...
        expect(await screen.findByText(/Conduct reports arrive next/i)).toBeInTheDocument();
